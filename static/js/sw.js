...
self.oninstall = function(event) {
  event.waitUntil(Promise.all([
    caches.get('trains-static-v3').then(function(cache) {
      return cache || caches.create('trains-static-v3');
    }).then(function(cache) {
      return cache.addAll([
        '/trained-to-thrill/',
